...
public class RegisterTest {
    ...
    @Test
    public void userRegister_OKResponse()throws Exception {
        try {
        ...
        try {
            RegisterTask task = new RegisterTask(context, new MockApiEndpoint(mockServer));
    ...
    @Test
    public void userRegister_BadResponse()throws Exception {
        try {
            mockServer = new MockWebServer();

            String filename = "responses/response_400_register.json";
    ...
    @Test
    public void userRegister_Emptyesponse()throws Exception {
        try {
            mockServer = new MockWebServer();
